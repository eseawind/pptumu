...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`pptumu` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `tm_machine`(`id`,`code`,`name`,`type_id`,`owner`,`is_rent`,`rend_fee`,`deleted`,`created_by`,`created`,`modified`) values (1,'1001','PC450',1,'--',0,0.00,0,'admin','2015-01-30 16:26:09','2015-01-30 16:26:09'),(2,'1002','PC300',1,'--',1,0.00,0,'admin','2015-01-30 17:01:02','2015-01-30 17:01:02');
...
/*Data for the table `tm_machinedistribution` */

LOCK TABLES `tm_machinedistribution` WRITE;

insert  into `tm_machinedistribution`(`id`,`project_id`,`machine_id`,`begin`,`end`,`verified`,`verified_by`,`deleted`,`created_by`,`created`,`modified`) values (5,1,1,'2015-02-10 12:00:11','2015-02-11 12:00:11',0,'admin',0,'admin','2015-02-04 23:32:56','2015-02-04 23:32:56');
...
insert  into `tm_material`(`id`,`code`,`name`,`type_id`,`unit`,`deleted`,`created_by`,`created`,`modified`) values (4,'1001','白水泥',1,'吨',0,'','2015-01-21 00:19:38','2015-01-21 00:19:38'),(5,'1003','水泥',1,'吨',0,'admin','2015-02-03 20:58:03','2015-02-03 20:58:03'),(6,'1004','石硝',1,'立方',0,'admin','2015-02-03 20:58:48','2015-02-03 20:58:48'),(7,'1005','石子',1,'立方',0,'admin','2015-02-03 20:59:54','2015-02-03 20:59:54');
...
/*Data for the table `tm_materialapplication` */

LOCK TABLES `tm_materialapplication` WRITE;

insert  into `tm_materialapplication`(`id`,`project_id`,`verified`,`verified_by`,`deleted`,`created_by`,`created`,`modified`) values (1,1,0,NULL,0,'admin','2015-02-02 23:35:14','2015-02-02 23:35:14'),(2,1,0,NULL,0,'admin','2015-02-02 23:36:10','2015-02-02 23:36:10'),(3,1,0,NULL,0,'admin','2015-02-03 20:54:43','2015-02-03 20:54:43');
...
/*Data for the table `tm_materialapplicationdetail` */

LOCK TABLES `tm_materialapplicationdetail` WRITE;

insert  into `tm_materialapplicationdetail`(`id`,`application_id`,`material_id`,`qty`) values (1,3,6,2.00),(2,3,7,2.00),(3,3,4,2.00);
...
/*Data for the table `tm_testation` */
