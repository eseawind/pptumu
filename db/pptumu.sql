...
--
-- Host: localhost
-- Generation Time: 2015-02-01 14:10:13
-- 服务器版本： 5.6.21
-- PHP Version: 5.5.19
...
(135, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-29 17:37:15', '', '', '0'),
(136, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-30 12:30:29', '', '', '0'),
(137, 'user', 1, ',0,', 0, 'admin', 'logout', '2015-01-30 16:00:20', '', '', '0'),
(138, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-30 16:12:29', '', '', '0'),
(139, 'user', 1, ',0,', 0, 'admin', 'logout', '2015-01-30 16:12:48', '', '', '0'),
(140, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-30 16:13:54', '', '', '0'),
(141, 'machine', 1, ',0,', 0, 'admin', 'created', '2015-01-30 16:26:10', '', '', '0'),
(142, 'user', 1, ',0,', 0, 'admin', 'logout', '2015-01-30 16:27:50', '', '', '0'),
(143, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-30 16:27:52', '', '', '0'),
(144, 'machine', 2, ',0,', 0, 'admin', 'created', '2015-01-30 17:01:02', '', '', '0'),
(145, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-31 15:20:26', '', '', '0'),
(146, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-31 17:07:23', '', '', '0'),
(147, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-31 17:27:46', '', '', '0'),
(148, 'user', 1, ',0,', 0, 'admin', 'login', '2015-01-31 19:20:14', '', '', '0'),
(149, 'user', 1, ',0,', 0, 'admin', 'login', '2015-02-01 09:03:13', '', '', '0'),
(150, 'user', 1, ',0,', 0, 'admin', 'login', '2015-02-01 16:18:11', '', '', '0'),
(151, 'user', 1, ',0,', 0, 'admin', 'login', '2015-02-01 21:03:07', '', '', '0');
...
INSERT INTO `tm_machine` (`id`, `code`, `name`, `type_id`, `owner`, `is_rent`, `rend_fee`, `deleted`, `created_by`, `created`, `modified`) VALUES
(1, '1001', 'PC450', 1, '--', 0, 0.00, 0, 'admin', '2015-01-30 16:26:09', '2015-01-30 16:26:09'),
(2, '1002', 'PC300', 1, '--', 1, 0.00, 0, 'admin', '2015-01-30 17:01:02', '2015-01-30 17:01:02');

-- --------------------------------------------------------

--
-- 表的结构 `tm_machineorder`
--

DROP TABLE IF EXISTS `tm_machineorder`;
CREATE TABLE IF NOT EXISTS `tm_machineorder` (
`id` int(11) NOT NULL,
...
--
-- 转存表中的数据 `tm_machinetype`
--

INSERT INTO `tm_machinetype` (`id`, `name`, `created_by`, `created`, `modified`) VALUES
(1, '挖掘机', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(2, '推土机', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(3, '压路机', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(4, '平地车', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(5, '自卸车', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(6, '铲车', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(7, '其他', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00');
...
--
-- 表的结构 `tm_materialorder`
--

DROP TABLE IF EXISTS `tm_materialorder`;
CREATE TABLE IF NOT EXISTS `tm_materialorder` (
`id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `created_by` varchar(30) NOT NULL,
  `verified` int(11) NOT NULL COMMENT '0: 未处理; 1: 通过审核 -1: 拒绝',
...
--
-- 表的结构 `tm_materialorderitem`
--

DROP TABLE IF EXISTS `tm_materialorderitem`;
CREATE TABLE IF NOT EXISTS `tm_materialorderitem` (
`id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL COMMENT 'material order ID',
...
(2, '安装建材', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(3, '装饰材料', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00'),
(4, '其他', 'admin', '2015-01-20 00:00:00', '2015-01-20 00:00:00');
...
CREATE TABLE IF NOT EXISTS `tm_report` (
`id` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tm_testation` (
`id` int(11) NOT NULL,
  `project_id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `content` text,
...
(1, 0, 'admin', '7fef6171469e80d32c0559f88b377245', '', 'Administrator', '', '', '', '0000-00-00', '', '', '', '', '', '', '', '', '', '', '', '0000-00-00', 30, '192.168.1.101', 1422795746, 0, '0000-00-00 00:00:00', '0'),
...
--
-- Indexes for table `tm_action`
--
ALTER TABLE `tm_action`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_bug`
--
ALTER TABLE `tm_bug`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_build`
--
ALTER TABLE `tm_build`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_burn`
--
ALTER TABLE `tm_burn`
 ADD PRIMARY KEY (`project`,`date`);

--
-- Indexes for table `tm_case`
--
ALTER TABLE `tm_case`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_casestep`
--
ALTER TABLE `tm_casestep`
 ADD PRIMARY KEY (`id`), ADD KEY `case` (`case`,`version`);
...
--
-- Indexes for table `tm_config`
--
ALTER TABLE `tm_config`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `unique` (`owner`,`module`,`section`,`key`);

--
-- Indexes for table `tm_dept`
--
ALTER TABLE `tm_dept`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tm_doclib`
--
ALTER TABLE `tm_doclib`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_effort`
--
ALTER TABLE `tm_effort`
 ADD PRIMARY KEY (`id`), ADD KEY `user` (`user`);

--
-- Indexes for table `tm_extension`
--
ALTER TABLE `tm_extension`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `code` (`code`), ADD KEY `name` (`name`), ADD KEY `addedTime` (`installedTime`);

--
-- Indexes for table `tm_file`
--
ALTER TABLE `tm_file`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tm_grouppriv`
--
ALTER TABLE `tm_grouppriv`
 ADD UNIQUE KEY `group` (`group`,`module`,`method`);

--
-- Indexes for table `tm_history`
--
ALTER TABLE `tm_history`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_lang`
--
ALTER TABLE `tm_lang`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `lang` (`lang`,`module`,`section`,`key`);

--
-- Indexes for table `tm_machine`
--
ALTER TABLE `tm_machine`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_machineorder`
--
ALTER TABLE `tm_machineorder`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_machinetype`
--
ALTER TABLE `tm_machinetype`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_material`
--
ALTER TABLE `tm_material`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_materialorder`
--
ALTER TABLE `tm_materialorder`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_materialorderitem`
--
ALTER TABLE `tm_materialorderitem`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_materialtype`
--
ALTER TABLE `tm_materialtype`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_module`
--
ALTER TABLE `tm_module`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_problem`
--
ALTER TABLE `tm_problem`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tm_productplan`
--
ALTER TABLE `tm_productplan`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_project`
--
ALTER TABLE `tm_project`
 ADD PRIMARY KEY (`id`), ADD KEY `project` (`type`,`begin`);

--
-- Indexes for table `tm_projectproduct`
--
ALTER TABLE `tm_projectproduct`
 ADD PRIMARY KEY (`project`,`product`);

--
-- Indexes for table `tm_projectstory`
--
ALTER TABLE `tm_projectstory`
 ADD UNIQUE KEY `project` (`project`,`story`);

--
-- Indexes for table `tm_release`
--
ALTER TABLE `tm_release`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `name` (`name`);

--
-- Indexes for table `tm_report`
--
ALTER TABLE `tm_report`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_story`
--
ALTER TABLE `tm_story`
 ADD PRIMARY KEY (`id`), ADD KEY `product` (`product`,`module`,`plan`,`type`,`pri`), ADD KEY `status` (`status`);

--
-- Indexes for table `tm_storyspec`
--
ALTER TABLE `tm_storyspec`
...
--
-- Indexes for table `tm_taskestimate`
--
ALTER TABLE `tm_taskestimate`
 ADD PRIMARY KEY (`id`), ADD KEY `task` (`task`);

--
-- Indexes for table `tm_team`
--
ALTER TABLE `tm_team`
 ADD PRIMARY KEY (`project`,`account`);

--
-- Indexes for table `tm_testation`
--
ALTER TABLE `tm_testation`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_testresult`
--
ALTER TABLE `tm_testresult`
 ADD PRIMARY KEY (`id`), ADD KEY `run` (`run`), ADD KEY `case` (`case`,`version`);

--
-- Indexes for table `tm_testrun`
--
ALTER TABLE `tm_testrun`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `task` (`task`,`case`);

--
-- Indexes for table `tm_testtask`
--
ALTER TABLE `tm_testtask`
 ADD PRIMARY KEY (`id`);

--
-- Indexes for table `tm_todo`
--
ALTER TABLE `tm_todo`
 ADD PRIMARY KEY (`id`), ADD KEY `user` (`account`);

--
-- Indexes for table `tm_user`
--
ALTER TABLE `tm_user`
 ADD PRIMARY KEY (`id`), ADD UNIQUE KEY `account` (`account`), ADD KEY `dept` (`dept`);

--
-- Indexes for table `tm_usercontact`
--
ALTER TABLE `tm_usercontact`
 ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `tm_userquery`
--
ALTER TABLE `tm_userquery`
 ADD PRIMARY KEY (`id`), ADD KEY `account` (`account`), ADD KEY `module` (`module`);

--
-- Indexes for table `tm_usertpl`
--
ALTER TABLE `tm_usertpl`
 ADD PRIMARY KEY (`id`), ADD KEY `account` (`account`);
...
--
-- AUTO_INCREMENT for table `tm_action`
--
ALTER TABLE `tm_action`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=152;
--
-- AUTO_INCREMENT for table `tm_bug`
--
ALTER TABLE `tm_bug`
MODIFY `id` mediumint(8) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_build`
--
ALTER TABLE `tm_build`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tm_case`
--
ALTER TABLE `tm_case`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_casestep`
--
ALTER TABLE `tm_casestep`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
...
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tm_config`
--
ALTER TABLE `tm_config`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_dept`
--
ALTER TABLE `tm_dept`
...
--
-- AUTO_INCREMENT for table `tm_doclib`
--
ALTER TABLE `tm_doclib`
MODIFY `id` smallint(5) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_effort`
--
ALTER TABLE `tm_effort`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_extension`
--
ALTER TABLE `tm_extension`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_file`
--
ALTER TABLE `tm_file`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tm_history`
--
ALTER TABLE `tm_history`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=68;
--
-- AUTO_INCREMENT for table `tm_lang`
--
ALTER TABLE `tm_lang`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_machine`
--
ALTER TABLE `tm_machine`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tm_machineorder`
--
ALTER TABLE `tm_machineorder`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_machinetype`
--
ALTER TABLE `tm_machinetype`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
-- AUTO_INCREMENT for table `tm_material`
--
ALTER TABLE `tm_material`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_materialorder`
--
ALTER TABLE `tm_materialorder`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_materialorderitem`
--
ALTER TABLE `tm_materialorderitem`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_materialtype`
--
ALTER TABLE `tm_materialtype`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT for table `tm_module`
--
ALTER TABLE `tm_module`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
-- AUTO_INCREMENT for table `tm_problem`
--
ALTER TABLE `tm_problem`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tm_productplan`
--
ALTER TABLE `tm_productplan`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tm_project`
--
ALTER TABLE `tm_project`
MODIFY `id` int(11) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT for table `tm_release`
--
ALTER TABLE `tm_release`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_report`
--
ALTER TABLE `tm_report`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_story`
--
ALTER TABLE `tm_story`
...
--
-- AUTO_INCREMENT for table `tm_taskestimate`
--
ALTER TABLE `tm_taskestimate`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_testation`
--
ALTER TABLE `tm_testation`
MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_testresult`
--
ALTER TABLE `tm_testresult`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_testrun`
--
ALTER TABLE `tm_testrun`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `tm_testtask`
--
ALTER TABLE `tm_testtask`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tm_todo`
--
ALTER TABLE `tm_todo`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
...
--
-- AUTO_INCREMENT for table `tm_usercontact`
--
ALTER TABLE `tm_usercontact`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_userquery`
--
ALTER TABLE `tm_userquery`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tm_usertpl`
--
ALTER TABLE `tm_usertpl`
MODIFY `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT;SET FOREIGN_KEY_CHECKS=1;
