...
/*Table structure for table `tm_machineorder` */

DROP TABLE IF EXISTS `tm_machineorder`;

CREATE TABLE `tm_machineorder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `tm_machineorder` */
...
/*Table structure for table `tm_materialorder` */

DROP TABLE IF EXISTS `tm_materialorder`;

CREATE TABLE `tm_materialorder` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `project_id` int(11) NOT NULL,
  `created_by` varchar(30) NOT NULL,
  `verified` int(11) NOT NULL COMMENT '0: 未处理; 1: 通过审核 -1: 拒绝',
...
/*Data for the table `tm_materialorder` */

/*Table structure for table `tm_materialorderitem` */

DROP TABLE IF EXISTS `tm_materialorderitem`;

CREATE TABLE `tm_materialorderitem` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
/*Data for the table `tm_materialorderitem` */
