...
CREATE TABLE `tm_project` (
  ...
  `serial_um` varchar(20) NOT NULL COMMENT '项目编号: YYMM+XXXX',
  `name` varchar(90) NOT NULL,
  ...
  `manager_id` int(11) DEFAULT NULL COMMENT '项目经理',
  `sub_manager_id` int(11) DEFAULT NULL COMMENT '副经理',
  `begin` date NOT NULL COMMENT '开工日期',
  `espected_completioin` date DEFAULT NULL COMMENT '预计竣工日期',
...
insert  into `tm_project`(`id`,`serial_um`,`name`,`client`,`address`,`type`,`manager_id`,`sub_manager_id`,`begin`,`espected_completioin`,`actual_completion`,`desc`,`deleted`,`created_by`,`created`,`modified`,`isCat`,`catID`,`parent`,`code`,`end`,`days`,`status`,`statge`,`pri`,`openedBy`,`openedDate`,`openedVersion`,`closedBy`,`closedDate`,`canceledBy`,`canceledDate`,`PO`,`PM`,`QD`,`RD`,`team`,`acl`,`whitelist`) values (1,'','企业网站第一期',NULL,NULL,'sprint',NULL,NULL,'2012-06-05',NULL,NULL,'开发企业网站的基本雏形。<br />','0',NULL,NULL,NULL,'0',0,0,'coWeb1','2012-12-04',184,'done','1','1','',0,'','',0,'',0,'productManager','projectManager','testManager','productManager','公司开发团队','open',''),(2,'','企业网站第二期',NULL,NULL,'sprint',NULL,NULL,'2013-06-05',NULL,NULL,'','0',NULL,NULL,NULL,'0',0,0,'coWebsite2','2014-06-04',365,'wait','1','1','',0,'','',0,'',0,'productManager','projectManager','testManager','productManager','公司开发团队','open','');
