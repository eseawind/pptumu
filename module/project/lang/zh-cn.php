<?php
/* 字段列表。*/
$lang->project->common        = '工程视图';
$lang->project->id            = '工程编号';
$lang->project->company       = '所属公司';
$lang->project->fromproject   = '所属工程';
$lang->project->iscat         = '作为目录';
$lang->project->type          = '工程类型';
$lang->project->parent        = '上级工程';
$lang->project->code          = '工程编号';
$lang->project->name          = '工程名称';
$lang->project->client        = '工程业主';
$lang->project->address       = '工程地点';
$lang->project->pm            = '工程经理';
$lang->project->sub_pm        = '工程经理';
$lang->project->dateRange     = '预计日期';
$lang->project->to            = '至';
$lang->project->begin         = '开工时间';
$lang->project->espected_completion = '预计竣工时间';
$lang->project->actual_completion = '实际竣工时间';
$lang->project->desc          = '工程说明';
$lang->project->end           = '结束日期';

$lang->project->days          = '可用工作日';
$lang->project->day           = '天';
$lang->project->status        = '工程状态';
...
$lang->project->order         = '工程排序';
$lang->project->products      = '相关产品';
$lang->project->childProjects = '子工程';
...
$lang->project->noProduct     = '无产品工程';
$lang->project->select        = '--请选择工程--';
$lang->project->createStory   = "新增需求";
$lang->project->all           = '所有';
$lang->project->undone        = '未完成';
$lang->project->unclosed      = '未关闭';
$lang->project->typeDesc      = '运维工程禁用燃尽图和需求。';
...
$lang->project->aclList['open']    = '默认设置(有工程视图权限，即可访问)';
$lang->project->aclList['private'] = '私有工程(只有工程团队成员才能访问)';
$lang->project->aclList['custom']  = '自定义白名单(团队成员和白名单的成员可以访问)';

/* 方法列表。*/
$lang->project->index            = '工程首页';
...
$lang->project->view             = "工程概况";
$lang->project->create           = "添加工程";
$lang->project->copy             = "复制工程";
$lang->project->delete           = "删除工程";
$lang->project->browse           = "浏览工程";
$lang->project->edit             = "编辑工程";
...
$lang->project->ajaxGetProducts  = '接口：获得工程产品列表';
...
/* 查询条件列表。*/
$lang->project->allProject      = '所有工程';
$lang->project->aboveAllProduct = '以上所有产品';
$lang->project->aboveAllProject = '以上所有工程';

/* 页面提示。*/
$lang->project->selectProject   = "请选择工程";
...
$lang->project->oneLineStats    = "工程<strong>%s</strong>, 代号为<strong>%s</strong>, 相关产品为<strong>%s</strong>，<strong>%s</strong>开始，<strong>%s</strong>结束，总预计<strong>%s</strong>工时，已消耗<strong>%s</strong>工时，预计剩余<strong>%s</strong>工时。";
...
$lang->project->whyNoStories    = "看起来没有需求可以关联。请检查下工程关联的产品中有没有需求，而且要确保它们已经审核通过。";
$lang->project->doneProjects    = '已结束';
$lang->project->unDoneProjects  = '未结束';
$lang->project->copyTeam        = '复制团队';
$lang->project->copyFromTeam    = '复制自工程团队： <strong>%s</strong>';
$lang->project->noMatched       = '找不到包含"%s"的工程';
$lang->project->copyTitle       = '请选择一个工程来复制';
$lang->project->copyTeamTitle   = '请选择一个工程团队来复制';
$lang->project->copyNoProject   = '没有可用的工程来复制';
$lang->project->copyFromProject = '复制自工程： <strong>%s</strong>';
...
/* 交互提示。*/
$lang->project->confirmDelete         = '您确定删除工程[%s]吗？';
$lang->project->confirmUnlinkMember   = '您确定从该工程中移除该用户吗？';
$lang->project->confirmUnlinkStory    = '您确定从该工程中移除该需求吗？';
$lang->project->errorNoLinkedProducts = '该工程没有关联的产品，系统将转到产品关联页面';
$lang->project->accessDenied          = '您无权访问该工程！';
$lang->project->tips                  = '提示';
$lang->project->afterInfo             = '工程添加成功，您现在可以进行以下操作：';
$lang->project->setTeam               = '设置团队';
$lang->project->linkStory             = '关联需求';
$lang->project->createTask            = '添加任务';
$lang->project->goback                = '返回工程首页';
